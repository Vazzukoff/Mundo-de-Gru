    ...
    <div className="relative w-full max-w-full" style={{ maxWidth: `${baseWidth}px` }}>
      <div className="relative">
        ...
        <button
          ...
          className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 rounded-full p-2 sm:p-3 shadow-lg transition-all duration-300 hover:scale-110 z-10 cursor-pointer"
        >
        ...
        <button
          onClick={handleNext}
          className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 rounded-full p-2 sm:p-3 shadow-lg transition-all duration-300 hover:scale-110 z-10 cursor-pointer"
        >
