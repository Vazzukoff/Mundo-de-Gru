          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed font-medium text-lg">
                Acogemos a los niños en nuestra guardería con amor y respeto, fomentando su autonomía y confianza en sí mismos. Entre juegos, 
                risas y momentos de exploración, construimos a lo largo del día lazos de amistad que fortalecen su desarrollo 
                emocional y social en nuestro nido.
              </p>
              <div className="flex items-center gap-3 bg-cyan-50 p-4 rounded-lg">
                <FaHeart className="text-cyan-500 text-xl" aria-hidden="true" />
                <span className="text-cyan-700 font-semibold">Atención personalizada</span>
              </div>
            </div>

            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-100 to-cyan-200 rounded-2xl transform rotate-3 scale-105" role="presentation"></div>
              <Image
                src="/images/servicios/guarderia/guarderia.JPG"
                alt="Servicio de guardería del nido infantil con niños jugando y explorando en ambiente seguro"
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 lg:p-12 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-100 to-amber-200 rounded-2xl transform -rotate-3 scale-105" role="presentation"></div>
              <Image
                src="/images/servicios/comedor/comedor.JPG"
                alt="Comedor nutritivo del nido infantil con alimentación balanceada supervisada por nutricionista"
                className="relative w-full h-80 lg:h-96 rounded-2xl shadow-lg object-cover transform rotate-1 hover:rotate-0 transition-transform duration-300"
                width={800}
                height={600}
                loading="lazy"
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <p className="text-gray-600 leading-relaxed font-medium text-lg">
                Ofrecemos comida diaria en nuestro nido con proteínas, carbohidratos y grasas saludables para el crecimiento de tu hijo, complementando 
              ...
              <div className="flex items-center gap-3 bg-amber-50 p-4 rounded-lg">
                <FaAppleAlt className="text-amber-500 text-xl" aria-hidden="true" />
